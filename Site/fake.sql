...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1380471197ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fake&table=compte">`fake`.`compte`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fake&table=transaction">`fake`.`transaction`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fake&table=user">`fake`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=payment&table=user">`payment`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=payment&table=compte">`payment`.`compte`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=payment&table=transaction">`payment`.`transaction`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=site&table=utilisateur">`site`.`utilisateur`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=site&table=compte">`site`.`compte`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=site&table=transaction">`site`.`transaction`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=payment&table=utilisateur">`payment`.`utilisateur`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="783d3a585026664c58544a7a54486023">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="payment" targettable="utilisateur">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `utilisateur`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fake" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fake" targettable="compte">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `compte`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fake" targettable="compte">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `compte`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fake" targettable="transaction">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `transaction`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fake" targettable="compte">
                            <div class="action_content">
